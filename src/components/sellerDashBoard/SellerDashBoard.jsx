...
const SellerDashBoard = () => {
  ...
  useEffect(() => {
    console.log(restockProducts, "fetc");
  });
    ...
    <div>
      ...
      {restockProducts.length > 0 ? (
        <div className={styles.productRestock}>
          ...
          {/* <div className={styles.fullproductRestockContainer}>
          {restockProducts.map((restockProduct , idx) =>(
            <div className={styles.productRestockContainer}>
            <ProductCardSeller
              key={restockProduct._id}
              id={restockProduct._id}
              title={restockProduct.title}
              price={Math.round(restockProduct.price)}
              ratingsAverage={restockProduct.ratingsAverage}
              imageCover={restockProduct.imageCover}
              priceAfterDisc={restockProduct.priceAfterDisc}
            />
          </div>
          ) )}
        </div> */}
